  ...
  try {
    ...
    if (signUpError) {
      ...
      if (signUpError.message === 'Database error saving new user') {
        userMessage = 'There was a database issue during registration. This might be a temporary problem. Please try again in a few minutes.';
        ...
        userMessage = 'Server error occurred. Please try again later or contact support if this persists.';
      }
    ...
    return {
      success: true,
      message: "Account created successfully! Please check your email to verify your account, then try signing in."
    };
